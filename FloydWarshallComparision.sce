...
//Code to compute the CPU time taken by the FloydWarshall routing algorithm to return the
...
//Application of the FloydWarshall algorithm
for i = 1:5                    //Run 5 iterations
